...
public class BoardPanel extends JPanel {
	...
	private static final Font LARGE_FONT = new Font("Arial", Font.BOLD, 18);

	
	private static final Font SMALL_FONT = new Font("Arial", Font.BOLD, 14);
	...
	public void paintComponent(Graphics g) {
		...
		if(tetris.isPaused()) {
			...
			String msg = tetris.isNewGame() ? "TETRIS" : "GOTOVA IGRA";
			g.drawString(msg, CENTER_X - g.getFontMetrics().stringWidth(msg) / 2, 150);
			g.setFont(SMALL_FONT);
			msg = "Pritisni ENTER za pocetak igre" + (tetris.isNewGame() ? "" : "");
